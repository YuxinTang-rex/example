...
public class ExportReports {
    public static void main(String[] args) {
        ...
        try {
            ...
            //  clear parametermap，将参数值改为华北,change the parameter value to North China and get ResultReport
            parameterMap.clear();
            for (int i = 0; i < parameters.length; i++) {
            ...
            OutputStream outputStream = new FileOutputStream(new File("C://Users//lx//Downloads//ExcelExport1.xls"));
